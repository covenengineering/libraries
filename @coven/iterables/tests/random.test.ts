...
Deno.test(
	...
	() =>
		assertEquals(iterableToArray(take(1)(seededRandom)), [
...
Deno.test(
	...
	() =>
		assertEquals(
			...
			[
				3.141_213_210_299_611,
				5.272_234_064_526_856,
				0.474_120_759_405_1957,
				3.828_503_423_370_421,
				0,
				6.255_908_024_497_33,
				9.114_267_439_581_454,
				4.361_579_724_587_5,
				9.915_763_438_679_278,
...
Deno.test(
	...
	() =>
		assertEquals(iterableToArray(take(1)(seededRandomInverse)), [
			3.141_213_210_299_611,
		]),
);
