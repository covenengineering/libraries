...
Deno.test("Other types", () =>
	assertFalse(
		...
		isAsyncIterable([]) ||
			// BigInt
			isAsyncIterable(BigInt(13)) || isAsyncIterable(BigInt("13")) ||
			isAsyncIterable(13n) ||
			// Boolean
			// deno-lint-ignore no-boolean-literal-for-arguments
			isAsyncIterable(true) || isAsyncIterable(false) ||
			// Date
			...
			// Number
			isAsyncIterable(13) || isAsyncIterable(Infinity) ||
			isAsyncIterable(NaN) ||
			// Object
			isAsyncIterable({}) || isAsyncIterable(Object.create(null)) ||
			// Promise
			...
			// String
			isAsyncIterable("string") || isAsyncIterable(`string`) ||
			// Symbol
