...
Deno.test("Comparing objects with different property values yields UpdateDifference", () =>
	assertEquals(
...
Deno.test(
	"Comparing array with less items yields DeleteDifference",
	() =>
		assertEquals(
...
Deno.test(
	"Comparing equal Dates yields nothing",
...
Deno.test(
	"Comparing equal Errors yields nothing",
	() =>
		assertEquals(
...
Deno.test("Comparing a real array and a fake array yields all the DeleteDifference", () =>
	assertEquals(
		_compare(["coven"])(
